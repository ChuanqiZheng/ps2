...
void obstacleCallback(const std_msgs::Bool& obstacle_msg) 
{ 
  g_obstacle_left = obstacle_msg.data; 
}
...
int main(int argc, char **argv) {
    ...
    ros::Subscriber obstacle_subscriber = n.subscribe("obstacle_left",1,obstacleCallback); 
    //some "magic numbers"
